    ...
    switch (action.type) {
      case "friendInviteResponse":
        if (!action.res.success) {
          ...
          state.current_friends = assign({}, state.current_friends, { [action.res.voter_we_vote_id]: action.res.friend_voter });
      ...
      case "friendInvitationByEmailSend":
        if (action.res.sender_voter_email_address_missing) {
          ...
          state.add_friends_by_email_step = "on_collect_email_step";
          state.error_message_to_show_voter = action.res.error_message_to_show_voter;
          return {
            ...state
          };
        } else {
      ...
      case "friendInvitationByFacebookVerify":
        state.facebook_invitation_status = {
          voter_device_id: action.res.voter_device_id,
          voter_has_data_to_preserve: action.res.voter_has_data_to_preserve,
          invitation_found: action.res.invitation_found,
          attempted_to_approve_own_invitation: action.res.attempted_to_approve_own_invitation,
      ...
      case "friendList":
        if (action.res.kind_of_list === "CURRENT_FRIENDS") {
          ...
          state.current_friends = action.res.friend_list;
          ...
          state.friend_invitations_sent_by_me = action.res.friend_list;
          ...
          state.friend_invitations_sent_to_me = action.res.friend_list;
          ...
          state.friend_invitations_processed = action.res.friend_list;
          ...
          state.suggested_friend_list = action.res.friend_list;
        }
