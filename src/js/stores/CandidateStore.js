  ...
  reduce (state, action) {
    ...
    switch (action.type) {
      ...
      case "candidateRetrieve":
        ...
        state.all_cached_candidates = all_cached_candidates;
        return {
          ...state
        };
      ...
      case "positionListForBallotItem":
        ...
        if (position_list_for_candidate) {
          ...
          state.position_list_from_advisers_followed_by_voter = position_list_from_advisers_followed_by_voter;
          return {
            ...state
          };
        } else {
      ...
      case "voterGuidesToFollowRetrieve":
        ...
        state.all_cached_positions_about_candidates = all_cached_positions_about_candidates;
        return {
          ...state
        };
